    ...
    <div className="bg-[rgba(178,206,243,0.2)] dark:bg-[rgba(10,0,0,0.9)] p-10 md:p-20">
      <div className=" mt-20">
        <div className="w-2/3 mx-auto text-center">
          <h1 className="font-archivo text-8xl font-bold uppercase dark:text-zinc-50">{project.title}</h1>
      ...
      <div className="w-full h-[90vh] bg-zinc-800 rounded-3xl overflow-hidden relative">
        <img src={project.bannerImage} alt="" className="w-full hover:scale-105 cursor-pointer transition-all duration-500" />
        <span className="flex flex-row gap-2 absolute bottom-5 left-5">
          {
      ...
      <div className="pt-10 lg:grid grid-cols-12 gap-10">
        ...
        <div className="col-span-9 pt-5 md:pt-0">
          <div className="flex flex-row gap-32 border-b pb-5">
            <span>
