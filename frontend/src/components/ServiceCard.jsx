...
const ServiceCard = ({ title, icon }) => {
  return (
    <div className="bg-[#F5F5F5] dark:bg-[rgba(10,0,0,0.7)] rounded-lg p-7 flex flex-col gap-10 cursor-pointer hover:bg-white dark:hover:bg-white  hover:shadow-2xl group">
